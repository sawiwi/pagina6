    ...
    document.getElementById('container-props-destacadas').innerHTML = filtrado.map(filtrado => 
        `<div class="item">
            <div class="media-entry">
                <a href="/detalle_propiedad.html?${data.id}&realtorId=${1}&statusId=${5}&companyId=${1}">
                ...
                <div class="bg-white m-body">
                    ...
                    <h3 class="mt-3"><a href="/detalle_propiedad.html?${data.id}&realtorId=${0}&statusId=${5}&companyId=${1}">${filtrado.title}</a></h3>
                    ...
                    <a href="/detalle_propiedad.html?${data.id}&realtorId=${1}&statusId=${5}&companyId=${1}" class="more d-flex align-items-center float-start">
