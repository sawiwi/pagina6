...
export const getProperties = async( page = 1, limit = 10, realtorId = 5, statusId = 5, companyId = 4, operationType = "", typeOfProperty = "", region = "", commune = "", min_price = 0, max_price = 10000000000000, bathrooms=0, bedrooms=0, surface_m2=0,covered_parking_lots=0) => {
...
export const getPropertiesForId = async( id , realtorId = 5, statusId = 5, companyId= 4) => {
