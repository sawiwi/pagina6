...
document.getElementById("buscar")?.addEventListener( "click", async() => {
  ...
  window.open(
    window.location.origin + `/propiedad.html?realtorId=${query.realtorId}&statusId=${query.statusId}&companyId=${query.companyId}`
  );
  ...
  console.log(meta);
	...
	setTimeout(() => {
        ...
        <div class="media-entry">
          <a href="/detalle_propiedad.html?${data.id}&realtorId=${0}&statusId=${1}&companyId=${1}">
          ...
          <div class="bg-white m-body">
            ...
            <h3 class="mt-3"><a href="/detalle_propiedad.html?${data.id}&realtorId=${0}&statusId=${1}&companyId=${1}">${data.title}</a></h3>
